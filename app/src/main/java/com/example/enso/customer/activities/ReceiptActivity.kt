...
class ReceiptActivity : AppCompatActivity() {
                ...
                .addValueEventListener(object : ValueEventListener {
                    override fun onDataChange(snapshot: DataSnapshot) {
                        ...
                        if (booking != null) {
                            ...
                            // Bookings node only contains IDs (customerId, salonId).
    ...
    private fun mapBookingData(booking: BookingModel) {
        ...
        binding.tvServicesList.text = booking.serviceName
        binding.tvSubtotal.text = "₹${booking.price}"
        binding.tvDiscount.text = "-₹0"
        binding.tvGrandTotal.text = "₹${booking.price}"
    }
